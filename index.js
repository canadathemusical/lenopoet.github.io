(function () {
    ...
    function setup() {
        ...
        lives = 5;
        words = ["cold", "empty", "alone", "blackness", "void", "nothing", "nihil", "abyss", "eternity", "futility"];
        messages = {
            win: 'You win!',
            lose: 'Game over!',
            guessed: " already guessed, please try again... Or don't. It's not important.",
        ...
        man = document.getElementById("mensche");
        guessInput = document.getElementById("letter");

        document.getElementById("mensche").innerHTML = 'You have ' + lives + ' lives remaining. Although, none of them have purpose.';
        output.innerHTML = '';
        ...
        if (guess) {
            ...
            if (availableLetters.indexOf(guess) > -1) {
                ...
                /* guess doesn't exist in current word and hasn't been guessed before, add to lettersGuessed, reduce lives & update user */
                    ...
                    lives--;
                    man.innerHTML = 'You have ' + lives + ' lives remaining, all of them senseless.';
                    if (lives === 0) gameOver();
                }
            }
